...
> This is a slight modification of [angular2-webpack-starter](https://github.com/AngularClass/angular-starter) that uses pug templates and stylus stylesheets rather than HTML and SCSS. The vast majority of the work was done by [AngularClass](https://angularclass.com).
...
[Services](https://gist.github.com/gdi2290/634101fec1671ee12b3e#_follow_@AngularClass_on_twitter),[Pug (formerly Jade)](https://pugjs.org), [Stylus](http://stylus-lang.com/),
...
Any stylesheets (Stylus or CSS) placed in the `src/styles` directory and imported into your project will automatically be compiled into an external `.css` and embedded in your production builds.
...
* How to use `Stylus` for css?
 *  * `loaders: ['to-string-loader', 'css-loader', 'stylus-loader']` and `@Component({ styleUrls: ['./filename.styl'] })` see Wiki page [How to include Stylus in components](https://github.com/AngularClass/angular-starter/wiki/How-to-include-stylus-support) for more information.
